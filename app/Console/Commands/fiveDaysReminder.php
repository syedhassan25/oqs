...
class fiveDaysReminder extends Command
{
     /**
     ...
     * @var string
     */
    protected $signature = 'reminderEmail:fivedays';
    ...
    {
        $limit = Carbon::now()->addDay(5)->format('Y-m-d');
        $monthName = Carbon::now()->addDay(5)->format('F');
    //  dd($limit);
