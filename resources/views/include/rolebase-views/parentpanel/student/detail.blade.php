...
@section('content')
<style>
#formlessonstudentnew input,select,textarea {
...
#formlessonstudentnew  .form-control {
  border-color: inherit !important;
  -webkit-box-shadow: none !important;
  box-shadow: none !important;
}
#formlessonstudentnew  .no-outline:focus {
        outline: none !important;
      }

#formlessonstudentnew  select {
  -webkit-appearance: none;
  -moz-appearance: none;
  text-indent: 1px;
  text-overflow: '';
}
#formlessonstudentnew  textarea:focus, input:focus{
    outline: none !important;
}
</style>
                ...
                <div class="example-box-wrapper">
                    <ul class="list-group list-group-separator row list-group-icons">
                        ...
                        <li class="col-md-2">
                            <a href="#tab-example-3" data-toggle="tab" class="list-group-item">
                                <i class="glyph-icon font-primary icon-history"></i>
                                Teacher History
                            </a>
                        </li>
                         <li class="col-md-2">
                        ...
                        <li class="col-md-2">
                            <a href="#tab-example-5" data-toggle="tab" class="list-group-item">
                                <i class="glyph-icon font-blue-alt icon-book"></i>
                                Lesson
                            </a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <tr>
                                    <td>{{$StudentEl->studentname}}</td>
                                    <td>{{$StudentEl->teacher->employeename}}</td>
                                    <td>{{$StudentEl->age}}</td>
                                    <td>{{$StudentEl->group}}</td>
                                    <td>{{$StudentEl->duration}}</td>
                                    <td>
                                         
                                             <table style="font-size:10px !important;text-align:center !important">
                                                <tr>
                                                    @foreach($StudentEl->studentdays as $val)
                                                    <td>
                                                    <table class="table-bordered">
                                                    <tr><td style="padding:5px;">{{$val->student_day_name}}</td></tr>
                                                    <tr><td style="padding:5px;">{{$val->student_time_text}}</td></tr>
                                                    </table>
                                                    </td>
                                                    @endforeach
                                                </tr>
                                    ...
                                    <td>
                                         {{ $StudentEl->language->pluck('languagename')->implode(', ') }}
                                     </td>                                                       
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="tab-pane fade" id="tab-example-2">
                            <p>   <div class="table-responsive">
                                    <table data-link="{{route('parentpanel.student.classes.attendancehistory')}}" id="todayclasses-datatable"
                        ...
                        <div class="tab-pane fade" id="tab-example-3">
                            <p><table id="teacherchangehistoryDatatable"
                                                                    data-link="{{route('parentpanel.student.change.teacherhistory')}}"
                                                                    class="table table-bordered table-hover">
                                                                    <thead>
                                                                        <tr>
                                                                            <th>Teacher</th>
                         ...
                         <div class="tab-pane fade" id="tab-example-4">
                            <p>
                                 <table id="dayschangehistoryDatatable"
                                                                    data-link="{{route('parentpanel.student.days.history.view.datatable')}}"
                                                                    class="table table-bordered table-hover">
                                                                    <thead>
                                                                        <tr>
                        ...
                        <div class="tab-pane fade" id="tab-example-5">
                            <p><table id="LessonDatatable" data-link="{{route('parentpanel.student.lesson.lessondatatable')}}"
                            class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>Course</th>
...
<div id="LessonModalNEw" class="modal fade" role="dialog">
    <div style="width:1250px !important" class="modal-dialog modal-lg">
        <form id="formlessonstudentnew" action="{{ route('teacherpanel.student.lesson.save') }}"  method="POST" role="form">
            <!-- Modal content-->
...
$(document).ready(function() {
    ...
    $('#LessonModalNEw select').attr('disabled',true);
    $('#LessonModalNEw input').attr('disabled',true);
    $('#LessonModalNEw textarea').attr('disabled',true);
   var oTable = $('#todayclasses-datatable').DataTable({
        ...
        columns: [
            ...
            
            {
             ...
             {
                data: 'student_day_name',
                name: 'studentattendance.student_day_name'
            },
             {
                data: 'timeConvertclasstime',
                name: 'timeConvertclasstime',
                orderable: false,
                searchable: false
            },
   ...
   $(document).on('click', '.btneditleson', function() {
        ...
        var route = '{{ route("parentpanel.student.lesson.edit", ":id") }}';
        ...
        $.get(route, {}, function(res) {
          ...
          $(`#formlessonstudentnew select#coursetype`).closest(".row").show();
            ...
            let memorizationid =  res.memorization_id;
               ...
               if(res.startlesson == 0){
                   $(`#formlessonstudentnew select[name="startlesson"]`).closest('.form-group').hide();
               }
               
                if(res.comments != ""){
                   $(`#formlessonstudentnew textarea[name="comments"]`).closest('.form-group').hide();
               }
               
                if(res.accent_type == ""){
                   $(`#formlessonstudentnew select[name="accent_type"]`).closest('.form-group').hide();
               }
             ...
             if(coursid == 4){
               ...
               $(`#formlessonstudentnew input[name="qaidachapterlesson"]`).val(res.qaidachapterlesson);
