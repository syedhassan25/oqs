                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="table-responsive">
                                    <table data-link="{{route('qualitycontrolpanel.student.test.save.view.datatable')}}" id="student-datatable"
...
$(document).ready(function() {
        ...
        let _token  = $('meta[name="csrf-token"]').attr('content');
			...
			$(document).on('click','.viewReportID',function(){
			    ...
			    var url = '{{ route("qualitycontrolpanel.student.test.attend.report.edit", ":id") }}';
