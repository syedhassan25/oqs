                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="panel">
                                        <form id="formstudent" action="{{ route('admissionpanel.teacher.booked-time.save') }}"  method="POST" role="form" >
                                                            ...
                                                            <div class="col-sm-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <label>Student <span
                                                                     ...
                                                                     <select style="width: 100%;" id="selectstudent" name="student" class="form-control select2 @error('student') is-invalid @enderror">
                                                                       <option  value="">Select
                                                                            Student
                                                                        </option>
                                                                        @foreach($student as $s)
                                                                                ...
                                                                                $sel = '';
                                                                                if($studetnid){
                                                                                  $sel  =  ($studetnid == $s->id) ? 'selected' : '';
                                                                                }
                                                                                
                                                                                ?>
                                                                        
                                                                            <option {{$sel}} value="{{$s->id}}">{{$s->studentname}}
                                                                            </option>
                                                                        @endforeach
                                                     ...
                                                     <div class="row">
                                                            <div class="col-sm-8">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="teacher" id="selectnewteacher" class="form-control @error('selectnewteacher') is-invalid @enderror">
...
$(document).ready(function() {
    ...
    @if($studetnid)
      $('#selectstudent').val('{{$studetnid}}').trigger('change');
    @endif
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                ...
                success: function(data) {
                     ...
                     swal({
                    title: "Good job!",
                    text: "Student Time Booked Successfully",
                    icon: "success",
                    button: "Close",
                });
