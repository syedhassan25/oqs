...
<div class="container">
    ...
    <div id="page-title">
        <h2>{{ $pageTitle }} <button id="addnewstudent" class="btn btn-primary pull-right px-2">Add Short
                Student</button>&nbsp;&nbsp;<a href="{{route('admissionpanel.student.create')}}" target="_blank" class="btn btn-primary pull-right px-2">Add Full
                Student</a>&nbsp;&nbsp;</h2>
        <p>{{ $subTitle }}</p>
        <!-- styles -->
 ...
 <div class="row">
                                        ...
                                        <div class="table-responsive">
                                            <table data-link="{{ route('admissionpanel.student.newFormdatatable') }}"
...
<div class="modal fade" id="addStudentModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="formstudent" action="{{ route('admissionpanel.student.store') }}" method="POST" role="form">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label>Father Name <span class="m-l-5 text-danger  errorlabelmy">
                                        *</span></label>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('detail') is-invalid @enderror"></textarea>
...
<div class="modal fade" id="SchduleModal" tabindex="-1" role="dialog" aria-labelledby="SchduleModalTitle"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="formstudentSchdule" action="{{ route('admissionpanel.student.demo.schdule.save') }}" method="POST"
                role="form">
                <div class="modal-body">
