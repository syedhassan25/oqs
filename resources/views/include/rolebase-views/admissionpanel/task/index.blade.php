...
<div class="container">
    ...
    <div class="panel">
      ...
      <table id="taskdatatable" data-link="{{route('admissionpanel.task.datatable')}}"
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                 ...
                                 <div class="table-responsive">
                                     <table id="pendingtaskdatatable" data-link="{{route('admissionpanel.task.pending.datatable')}}"
                                    style="width:100% important" class="table table-bordered table-hover">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                 ...
                                 <div class="table-responsive">
                                     <table id="completedtaskdatatable" data-link="{{route('admissionpanel.task.completed.datatable')}}"
                                    style="width:100% important" class="table table-bordered table-hover">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <table id="taskAssigneddatatable" data-link="{{route('admissionpanel.taskAssigned.datatable')}}"
                                    style="width:100% important" class="table table-bordered table-hover">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                 ...
                                 <div class="table-responsive">
                                     <table id="canceltaskdatatable" data-link="{{route('admissionpanel.task.cancel.datatable')}}"
                                    style="width:100% important" class="table table-bordered table-hover">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                 ...
                                 <div class="table-responsive">
                                     <table id="futuretaskdatatable" data-link="{{route('admissionpanel.task.future.datatable')}}"
                                    style="width:100% important" class="table table-bordered table-hover">
    ...
    <div id="taskcompletiondateModal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <!-- Modal content-->
            <div class="modal-content">
                <form id="taskcompletiondateForm" method="post" action="{{ route('admissionpanel.task.store') }}"
                    enctype="multipart/form-data">
...
$(document).ready(function() {
   ...
   var recordsTotal = this.api().page.info().recordsTotal;
    ...
    $(document).on('click','.btntask',function(){
        ...
        $.post('{{route("admissionpanel.task.status.change")}}',{_token:_token,taskstatus:taskstatus,id:id},function(res){
