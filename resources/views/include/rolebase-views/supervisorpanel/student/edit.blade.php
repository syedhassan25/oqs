                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form id="formstudent" action="{{ route('supervisorpanel.student.update') }}" method="POST"
                                    role="form">
                                    @csrf
                                    <div class="panel">
                                        <div class="panel-body">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane fade active in" id="tab-example-1">
                                                        ...
                                                        <div class="row">
                                                                    ...
                                                                    <select id="academicStatusChange"
                                                                        ...
                                                                        <option
                                                                            ...
                                                                            value="6">Pending</option>
                                                                             <option
                                                                            {{($targetStudent->academicStatus == '7') ? 'selected' :''}}
                                                                            value="7">Inprocess</option>
                                                                    </select>
                                                            ...
                                                            <div id="academicStatusModal" class="modal fade" role="dialog">
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="duration"
                                                                        ...
                                                                        <option
                                                                            {{($targetStudent->duration == '10') ? 'selected' :''}}
                                                                            value="10">10</option>
                                                                        <option
                                                                            {{($targetStudent->duration == '15') ? 'selected' :''}}
                                                                            value="15">15</option>
                                                                        <option
                                                                            {{($targetStudent->duration == '20') ? 'selected' :''}}
                                                                            value="20">20</option>
                                                                        <option
                                                                            {{($targetStudent->duration == '30') ? 'selected' :''}}
                                                                            value="30">30</option>
                                                                        <option
                                                                            {{($targetStudent->duration == '45') ? 'selected' :''}}
                                                                            value="45">45</option>
                                                                        <option
                                                                            {{($targetStudent->duration == '60') ? 'selected' :''}}
                                                                            value="60">60</option>
                                                                    </select>
                                                    ...
                                                    <div class="tab-pane fade" id="tab-example-3">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                   ...
                                                                   <table id="LessonDatatable" data-link="{{route('demonstrationpanel.student.lesson.lessondatatable')}}"
...
<div id="LessonModalNEw" class="modal fade" role="dialog">
    <div style="width:1250px !important" class="modal-dialog modal-lg">
        <form id="formlessonstudentnew" action="{{ route('demonstrationpanel.student.lesson.save') }}"  method="POST" role="form">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
...
<div class="modal fade" id="feedbackModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="feedBackform" action="{{route('supervisorpanel.student.teacher.feedback')}}" method="post">
                <div class="modal-header">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="studentid" class="studentid" value="{{ request()->route('id') }}">
                                <input type="hidden" name="teacherid" class="teacherid" value="{{$targetStudent->teacher_id}}">
...
<div class="modal fade" id="classRecoveryModal" tabindex="-1" role="dialog" aria-labelledby="SchduleModalTitle"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form id="formstudenrecoveryclass" action="{{ route('supervisorpanel.student.recovery.class.schdule.save') }}"
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label>Teacher <span class="m-l-5 text-danger  errorlabelmy">
                                        *</span></label>
                                <select id="recoveryclassTeacher" name="recoveryclassTeacher" class="form-control recoveryclassTeacher">
                                    
                                    <option value="">Select Teacher</option>
                                    @foreach($teacherlist as $val)
                                       <option {{($targetStudent->teacher_id == $val->id) ? 'selected'  : ''}} value="{{$val->id}}">{{$val->employeename}}</option>
                                    @endforeach
                                
                                </select>
                                <input type="hidden" class="recoverystudent"  name="student_id" value="{{request()->route('id')}}" />
                                 <input type="hidden" class="attendance_id"  name="attendance_id" value="" />
                                 <input type="hidden" class="currentteacherid"  name="currentteacherid" value="" />
                                <span class="text-danger">@error('recoveryclassTeacher')
                                    {{ $message }}
                                    @enderror</span>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label>Time <span class="m-l-5 text-danger  errorlabelmy">
                                        *</span></label>
                                <input name="recoveryclasstime" id="recoveryclasstime" value="" class="timepicker  form-control recoveryclasstime"
                                    type="text">
                                <span class="text-danger">@error('localtime')
                                    {{ $message }}
                                    @enderror</span>
                            </div>
                        </div>
                       ...
                       <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <span class="text-danger">@error('recoveryclassDate')
                                    {{ $message }}
                                    @enderror</span>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="id" value="" />
                                <span class="text-danger">@error('recoveryclasspayment')
                                    {{ $message }}
                                    @enderror</span>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label>Class Issue <span class="m-l-5 text-danger  errorlabelmy">
                                        *</span></label>
                                <select name="recoveryclassattendIssue" class="form-control recoveryclassattendIssue">
                                    <option value="">Select Class Attend Issue</option>
                                     <option value="1">Teacher</option>
                                      <option value="2">Company</option>
                                    </select>
                                <input type="hidden" name="id" value="" />
                                <span class="text-danger">@error('recoveryclassattendIssue')
                                    {{ $message }}
                                    @enderror</span>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="comment"
                                    class="form-control schduleDate @error('recoveryclasscomment') is-invalid @enderror "></textarea>

                                <span class="text-danger">@error('recoveryclasscomment')
                                    {{ $message }}
                                    @enderror</span>
                            </div>
                        </div>
...
// console.log('localtimeget',localtimeget)
    ...
    $(document).on('change', '#countrydrp', function() {
       ...
       $(document).on('click', '.addLessonbtn', function(e) {
        ...
        var route = '{{ route("demonstrationpanel.student.lesson.getlastlesson", ":id") }}';
       ...
       $(document).on('click', '.btneditleson', function() {
        ...
        var route = '{{ route("demonstrationpanel.student.lesson.edit", ":id") }}';
...
$(document).ready(function() {
    ...
    var acdemichistoryDatatable = $('#acdemichistoryDatatable').DataTable({
        ...
        columns: [
            ...
            {
                data: 'created_at',
                name: 'academicstatuschange.created_at',
            }
        ]
    });
...
// classrecoverytable
            ...
            $.ajax({
                ...
                data: {studentid:studentid,date:reccoveryclassdate,_token:_token},
                dataType: 'json',
                type: 'POST',
                success: function(data) {
                  console.log(data)
                  ...
                  if(data.classdata.length > 0){
                      let html  = `<tr>
                                    ...
                                    <td><button type="button" data-id='${data.classdata[0].id}' class="btn btn-primary btnrecoverymodal">Recovery</button></td>
                               </tr>`
        ...
        $(document).on('click','.btnrecoverymodal',function(){
                ...
                $('#formstudenrecoveryclass #recoveryclassTeacher').val("{{$targetStudent->teacher_id}}").trigger('change');
                    ...
                    .then((willDelete) => {
                      if (willDelete) {
                            ...
                            let studentid = "{{request()->route('id')}}";
                              ...
                              $.post('{{route("admin.student.relica.create")}}',{studentid:studentid,_token:_token},function(res){
                                console.log(res);
...
@if($Alldaysstudent)
        // window.defaultevent =     JSON.stringify(JSON.parse("{{json_encode($Alldaysstudent)}}".replace(/&quot;/g,'"')));
          ...
          localStorage.setItem("alldayAttendancestudent",JSON.stringify(JSON.parse("{{json_encode($Alldaysstudent)}}".replace(/&quot;/g,'"'))));
