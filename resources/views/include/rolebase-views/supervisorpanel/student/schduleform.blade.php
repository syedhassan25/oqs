                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table data-link="{{route('supervisorpanelstudent.schdule.datatable')}}"
...
$(document).ready(function() {
    ...
    $(document).on('click', '.btnstudentdetail', function() {
        ...
        var route = '{{ route("supervisorpanelstudent.detail", ":id") }}';
    ...
    function changeStatus(formData) {
        ...
        $.ajax({
            url: "{{ route('supervisorpanelstudent.academicstatus') }}",
            method: "POST",
            data: formData,
            success: function(res) {
                swal({
