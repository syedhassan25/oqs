...
<div class="container">
 ...
 <div class="row">
                                        ...
                                        <div class="table-responsive">
                                            <table data-link="{{ route('supervisorpanel.student.newFormdatatable') }}"
...
<div class="modal fade" id="SchduleModal" tabindex="-1" role="dialog" aria-labelledby="SchduleModalTitle"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="formstudentSchdule" action="{{ route('supervisorpanel.student.demo.schdule.save') }}" method="POST"
                role="form">
