                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="table-responsive">
                                    <table data-link="{{route('supervisorpanel.student.datatable')}}" id="student-datatable"
...
$(document).ready(function() {
    ...
    $(document).on('click', '.btnstudentdetail', function() {
        ...
        var route = '{{ route("supervisorpanel.student.detail", ":id") }}';
...
$.ajax({
    url: "{{ route('supervisorpanel.student.academicstatus') }}",
    method: "POST",
    data: formData,
    success: function(res) {
        swal({
