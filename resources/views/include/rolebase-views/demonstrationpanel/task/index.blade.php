...
<div class="container">
    ...
    <div class="panel">
      ...
      <table id="taskdatatable" data-link="{{route('demonstrationpanel.task.datatable')}}"
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                 ...
                                 <div class="table-responsive">
                                     <table id="pendingtaskdatatable" data-link="{{route('demonstrationpanel.task.pending.datatable')}}"
                                    style="width:100% important" class="table table-bordered table-hover">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                 ...
                                 <div class="table-responsive">
                                     <table id="completedtaskdatatable" data-link="{{route('demonstrationpanel.task.completed.datatable')}}"
                                    style="width:100% important" class="table table-bordered table-hover">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <table id="taskAssigneddatatable" data-link="{{route('demonstrationpanel.taskAssigned.datatable')}}"
                                    style="width:100% important" class="table table-bordered table-hover">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                 ...
                                 <div class="table-responsive">
                                     <table id="canceltaskdatatable" data-link="{{route('demonstrationpanel.task.cancel.datatable')}}"
                                    style="width:100% important" class="table table-bordered table-hover">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                 ...
                                 <div class="table-responsive">
                                     <table id="futuretaskdatatable" data-link="{{route('demonstrationpanel.task.future.datatable')}}"
                                    style="width:100% important" class="table table-bordered table-hover">
...
<!--ckeditor-->
    ...
    <div id="taskcompletiondateModal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <!-- Modal content-->
            <div class="modal-content">
                <form id="taskcompletiondateForm" method="post" action="{{ route('demonstrationpanel.task.store') }}"
                    enctype="multipart/form-data">
...
CKEDITOR.replace('editor1');
   ...
   var recordsTotal = this.api().page.info().recordsTotal;
    ...
    $(document).on('click','.btntask',function(){
        ...
        $.post('{{route("demonstrationpanel.task.status.change")}}',{_token:_token,taskstatus:taskstatus,id:id},function(res){
