                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form id="formstudent" action="{{ route('demonstrationpanel.student.update') }}" method="POST"
                                    role="form">
                                    @csrf
                                    <div class="panel">
                                        <div class="panel-body">
...
// console.log('localtimeget',localtimeget)
 ...
 let dayinners = ["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"];
    ...
    $(document).on("change", ".studenttimeclass", function(e) {
        ...
        let changetimezone = toTimeZoneHouradd(dateTime, $('#timezoneName').val(),minutes,'{{$timeChangeEuropeStatusStudenttime}}','{{$timeChangeEuropeStatusAmerica}}','{{$timeChangeEuropeStatusEurope}}');
    ...
    let url  = '{{route("demonstrationpanel.teacher.search")}}';
